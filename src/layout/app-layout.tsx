...
import { FiMail, FiUsers, FiMenu, FiUser, FiMessageCircle, FiFile, FiBox, FiBriefcase, FiCheck } from 'react-icons/fi';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['data-scientist', 'administrator', 'security-analyst'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Model', path: '/models', entity: 'model', service: AccessServiceEnum.PROJECT, icon: FiBox },
    {
